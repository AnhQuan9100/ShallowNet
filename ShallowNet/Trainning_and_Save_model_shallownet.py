...
# Cách dùng 1 - Trainning model: Trainning_model_shallownet.py -d datasets/animals
# Cách dùng 2 - Lưu model: Trainning_and_Save_model_shallawnet.py -d datasets/animals -m shallownet.hdf5

ap = argparse.ArgumentParser()
ap.add_argument("-d", "--dataset", required=True, help="Nhập folder chứa dữ liệu")
ap.add_argument("-m", "--model", required=True, help="Nhập tên file lưu model")
